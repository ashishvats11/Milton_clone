    ...
    return(
        <div class="flex justify-around bg-orange-50 h-10 border-b-2 border-slate-200 px-14 py-10 fixed w-full z-10">
            <div className=" flex items-center "> 
                <img src={logo} className='w-6 h-6 m-1 bg-gray-400 p-1 rounded-md'></img>
            ...
            <div class="flex justify-center " >
                <ul class="flex items-center mx-9 ">
                    ...
                    <button className="bg-slate-200 text-lg text-black rounded-xl px-3.5 py-1.5 font-medium mx-2.5  transform hover:scale-110 transition ease-out duration-500">Log in</button>
