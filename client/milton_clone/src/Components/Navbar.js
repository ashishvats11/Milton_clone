        ...
        <div class="flex justify-around bg-orange-50 h-10 border-b-2 border-slate-200 px-14 py-10 fixed w-full">
            ...
            <div class="flex justify-center " >
                <ul class="flex items-center mx-9 ">
                    ...
                    <button className="bg-slate-200 text-lg rounded-xl px-3.5 py-1.5 font-medium mx-2.5">Log in</button>
                    <button className="bg-gray-800  text-lg text-orange-50 font-medium rounded-xl px-4 py-1.5">GetStarted</button>
